...
const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  return (
    <>
      ...
      `}</style>
      <div
        className={`profile-view tab-page-wrapper fixed inset-0 overflow-y-auto overflow-x-hidden ${contentLoaded ? 'tab-content-enter-active' : ''}`}
        style={{
      ...
      >
        <div className="tab-inner-content relative z-10 min-h-screen pt-16 md:pt-20 px-4 md:px-6 pb-24">
          <div className="max-w-md mx-auto space-y-6">
            ...
            {/* Блок: Прогресс */}
            <div className="rounded-2xl p-4 md:p-5" style={blockStyle}>
              <h2
...
export const ProfileSkeleton: React.FC = () => (
  <div className="profile-view tab-page-wrapper fixed inset-0 overflow-y-auto overflow-x-hidden">
    <div className="tab-inner-content relative z-10 min-h-screen pt-16 md:pt-20 px-4 md:px-6 pb-24">
      <div className="max-w-md mx-auto space-y-6">
        <div className="flex flex-col items-center text-center pt-2 pb-4">
          <Skeleton
