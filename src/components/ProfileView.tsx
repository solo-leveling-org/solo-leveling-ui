    ...
    <>
      ...
      >
        <div className="tab-inner-content relative z-10 flex-1 min-h-0 flex flex-col pt-16 md:pt-20 px-4 md:px-6 pb-24 overflow-hidden">
          <div className="max-w-md mx-auto flex-1 min-h-0 flex flex-col justify-center space-y-4 md:space-y-6 overflow-hidden">
            ...
            <div className="flex flex-col items-center text-center pt-0 pb-2 md:pt-2 md:pb-4 flex-shrink-0">
              <div className="relative flex-shrink-0 mb-2 md:mb-4">
                <Avatar
                  className="relative w-20 h-20 md:w-32 md:h-32 border-2"
                  style={{
                ...
                <div
                  className="absolute -bottom-0.5 -right-0.5 rounded-full flex items-center justify-center font-tech font-bold border-2 min-w-[1.75rem] min-h-[1.75rem] w-7 h-7 md:min-w-[2.25rem] md:min-h-[2.25rem] md:w-9 md:h-9 text-xs md:text-sm"
                  style={{
              ...
              <h1
                className="text-xl md:text-3xl font-tech font-bold mb-0.5 md:mb-1 px-2"
                style={{ color: '#e8f4f8', textShadow: '0 0 12px rgba(180, 220, 240, 0.2)' }}
              >
                {user.firstName || ''} {user.lastName || ''}
              </h1>
              {isOwnProfile && user.username && (
                <p className="text-xs md:text-sm font-tech mb-1 md:mb-3" style={{ color: 'rgba(220, 235, 245, 0.65)' }}>
                  @{user.username}
                </p>
              )}
              <span
            ...
            {/* Блок: Прогресс */}
            <div className="rounded-2xl p-3 md:p-5 flex-shrink-0" style={blockStyle}>
              <h2
            ...
            <div className="rounded-2xl p-3 md:p-5 flex-shrink-0" style={blockStyle}>
              <h2
                className="text-sm font-tech font-bold flex items-center mb-2 md:mb-4"
                style={sectionTitleStyle}
              >
              ...
              <div className="grid grid-cols-3 gap-2 md:gap-3">
                ...
                >
                  <div className="profile-icon-wrapper flex justify-center mb-1 md:mb-2" style={{ color: '#e8f4f8' }}>
                    <Icon type="dumbbell" size={22} />
                  </div>
                  <div className="text-lg md:text-xl font-tech font-bold" style={{ color: '#e8f4f8' }}>
                    {strength}
                  </div>
                  <div className="text-[9px] md:text-xs font-tech mt-0.5" style={{ color: 'rgba(220, 235, 245, 0.7)' }}>
  ...
  <div className="profile-view tab-page-wrapper fixed inset-0 overflow-hidden flex flex-col">
    <div className="tab-inner-content relative z-10 min-h-screen pt-16 md:pt-20 px-4 md:px-6 pb-24">
      <div className="max-w-md mx-auto space-y-6">
        ...
        >
          <Skeleton className="h-4 w-24 mb-3" style={{ background: 'rgba(255, 255, 255, 0.08)' }} />
          <Skeleton className="h-3 w-full rounded-full" style={{ background: 'rgba(255, 255, 255, 0.08)' }} />
        </div>
