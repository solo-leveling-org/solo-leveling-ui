        ...
        <div className="relative z-10 min-h-screen pt-16 md:pt-20 px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 mb-8">
            {allTopics.map((topic, index) => {
              ...
              Math.min(100, Math.round((currentExp / maxExp) * 100));
              return (
                  <button
                      key={topic}
                      type="button"
                  ...
                  >
                    {saving ? (
                        <>
                          ...
                          ></div>
                          <span
                              className="whitespace-nowrap text-xs md:text-sm truncate">{t('topics.saving')}</span>
                        </>
                    ) : (
                        <>
                          ...
                          <span
                              className="whitespace-nowrap text-xs md:text-sm">{t('topics.save')}</span>
                        </>
                    )}
                  </button>
                </div>
